...
- [Portada](#portada)
- [Índice](#índice)
- [Explicación de la aplicación - Parte I](#explicación-de-la-aplicación)
  - [Descripción general](#descripción-general)
  - [Pantalla principal: Lista de pedidos](#pantalla-principal--lista-de-pedidos)
  - [Crear un nuevo pedido](#crear-un-nuevo-pedido)
  - [Seleccionar y añadir productos](#seleccionar-y-añadir-productos)
  - [Ajustar cantidades de productos](#ajustar-cantidades-de-productos)
  - [Ver resumen del pedido](#ver-resumen-del-pedido)
  - [Guardar pedido y validaciones](#guardar-pedido-y-validaciones)
  - [Editar un pedido existente](#editar-un-pedido-existente)
